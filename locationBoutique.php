                ...
                <section class="deals-style-two">
                    <div class="auto-container">
                        ...
                        <div class="grid">
                            <div class="deals-grid-content grid-item">
                                <div class="row clearfix">
                                    <?php
                                        $selectFilter = $bdd->prepare("SELECT * FROM annonces WHERE statut = '1' AND categorie = 'Boutique'  ORDER BY dates DESC ");
                        ...
                        <div class="lower-content">
                            ...
                            <div class="title-text"><h4><a href="agents-details.html"><?=$dataFilter['localisation']?></a></h4></div>
                            ...
                            <div class="btn-box"><a href="detailsLocation.php?k=<?=$dataFilter['id_annonces']?>&&location=kijsfdvh" class="theme-btn btn-two">Details</a></div>
                                        ...
                                        ?>
                                                <center><h4>Aucune location d'hotel pour le moment</h4></center>
                                        <?php
                                    }
                                    ?>
