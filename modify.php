...
if (isset($_GET['post']) && !empty($_GET['post'])) {
    $post = $_GET['post'];
    $select_specify = $bdd->prepare("SELECT * FROM collocannonces WHERE id_annonce = '$post' ");
                        ...
                        <div class="tab active-tab" id="tab-1">
                            <div class="general-information">
                                ...
                                <div class="inner-box default-form">
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-lg-6 col-md-6 col-sm-12 column">
                                            ...
                                            <label for="">Type de chambre</label>
                                                <div class="select-box">
                                                    ...
                                                    <option value="<?=$dataPost['type']?>"><?=$dataPost['type']?></option>
                                        ...
                                        <div class="col-lg-4 col-md-6 col-sm-12 column">
                                            <div class="field-input">
                                                <label>Prix</label>
                                                <div class="select-box">
                                                    <input type="number" name="prix" value="<?=$dataPost['prix']?>" placeholder="Ex : 15.000"  id="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-6 col-sm-12 column">
                                            <div class="field-input">
                                                ...
                                                <div class="select-box">
                                                    <input type="number" name="personne" value="<?=$dataPost['personne']?>" placeholder="nombres de collocataires"  id="">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <button class="theme-btn btn-one" type="submit" name="modify">Poster</button>
                                </form>
                                </div>
                            </div>
                        </div>
