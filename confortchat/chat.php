...
if (isset($_GET['sdr'],$_GET['stsdr'],$_GET['rcv'],$_GET['strcv']) && !empty($_GET['sdr'] && $_GET['stsdr'] && $_GET['rcv'] && $_GET['strcv']) ) {
   $sender = $_GET['sdr'];
   $statut_sender = $_GET['stsdr'];
   $receiver = $_GET['rcv'];
   $statut_receiver = $_GET['strcv'];




   if ($statut_receiver == "demarcheur") {
    $selectProfile = $bdd->prepare("SELECT * FROM demarcheurs WHERE email = '$receiver' ");
    ...
    $etats = "demarcheur";
    $phone = $dataDemarcheur["whatsapp"].'/'.$dataDemarcheur['telephone'];
    $location = $dataDemarcheur['pays'].','.$dataDemarcheur['ville'];
   }elseif ($statut_receiver == "utilisateur" ) {
    $selectProfile = $bdd->prepare("SELECT * FROM collocusers WHERE email = '$receiver' ");
    $selectProfile->execute();
...
<head>
        ...
        <title>Conforth0use Tchat</title>
                ...
                <div class="container h-100">
                    ...
                    <div class="d-flex flex-column h-100 position-relative">
                        ...
                        <div class="chat-body hide-scrollbar flex-1 h-100">
                            ...
                            <div class="py-6 py-lg-12" id="showMessage"></div>
                        ...
                        <div class="chat-footer pb-3 pb-lg-7 position-absolute bottom-0 start-0">
                            ...
                            <!-- Chat: Form -->
                            <form class="chat-form rounded-pill bg-dark" method="POST" enctype="multipart/form-data" id="send_msg" data-emoji-form="">
                                <div class="row align-items-center gx-0">
                                    ...
                                    <div class="col">
                                        <div class="input-group">
                                            <textarea class="form-control px-0" placeholder="Type your message..." rows="1" data-emoji-input="" data-autosize="true" id="id_msg" name="msg"></textarea>
                    ...
                    <script>
                        jQuery(document).ready(function(){
                            jQuery("#send_msg").submit(function(e){
                            e.preventDefault();
                                var msg = document.querySelector("#id_msg").value;
                                var sender = "<?=$sender?>";
                                var senderStatut = "<?=$statut_sender?>";
                                var receiver = "<?=$receiver?>";
                                var receiverStatut = "<?=$statut_receiver?>";
                                $.ajax({
                                    type: "POST",
                                    url: "php/post.php",
                                    data: {msg:msg,sender:sender,senderStatut:senderStatut,receiver:receiver,receiverStatut:receiverStatut},
                ...
                <div class="offcanvas-body hide-scrollbar">
                    ...
                    <div class="text-center py-10">
                        <div class="row gy-6">
                            ...
                            <div class="col-12">
                                <h4><?=$name?></h4>
                                <p style="text-transform: capitalize;"><?=$etats?></p>
                            </div>
                        </div>
                    </div>
                    <!-- Avatar -->
                    ...
                    <div class="tab-content py-2" role="tablist">
                        ...
                        <div class="tab-pane fade show active" id="offcanvas-tab-profile" role="tabpanel">
                            ...
                            <ul class="list-group list-group-flush border-top mt-8">
                                ...
                                <li class="list-group-item">
                                    <a href="#" class="text-danger">Supprimer tous les messages</a>
                                </li>
                            </ul>
                        </div>
                        <!-- Profile -->
                        ...
                        <div class="tab-pane fade" id="offcanvas-tab-media" role="tabpanel">
                            <div class="row row-cols-3 g-3 py-6">
                               ...
                               <?php
                               $selectMedias = $bdd->prepare("SELECT * FROM chat WHERE (mail_sender = '$sender' AND mail_receiver = '$receiver') OR (mail_sender = '$receiver' AND mail_receiver = '$sender') AND type = 'images' ORDER BY dates DESC");
                               $selectMedias->execute();
                               $rowMedias = $selectMedias->rowCount();
                               if ($rowMedias == true) {
                                   while ($dataMedias = $selectMedias->fetch()) {
                                      ?>
                                            <div class="col">
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#modal-media-preview" data-theme-img-url="<?=$dataMedias['images']?>">
                                                    <img class="img-fluid rounded" src="<?=$dataMedias['images']?>" alt="">
                                                </a>
                                            </div>
                                      <?php
                                   }
...
function ()
{
    jQuery(document).ready(function(){
        ...
        $.ajax({
            ...
            data: {sender:sender,senderStatut:senderStatut,receiver:receiver,receiverStatut:receiverStatut},
            success: function(html){
