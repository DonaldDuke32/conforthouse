              ...
              <table class="table table-sm table-nowrap card-table">
                ...
                <tbody class="list">
                    ...
                    <?php
                        ...
                        $infoAnnonces = $bdd->prepare('SELECT * FROM collocannonces ORDER BY id DESC');
                        ...
                        while ($dataAnnoncesInfo = $infoAnnonces->fetch()){
                            ...
                            <tr>
                                <?php
                                    ...
                                    $photoColoc = $bdd->prepare('SELECT * FROM collocimg WHERE id_annonce=:id_annonce');
                                    $photoColoc->bindvalue(':id_annonce', $dataAnnoncesInfo['id_annonce']);
                                    $photoColoc->execute();

                                    while ($dataPhotoColoc = $photoColoc->fetch()){
                                        ?>
                                        <td class="orders-order">
                                        <a href="../<?= $dataPhotoColoc['file']?>"><img src="../<?= $dataPhotoColoc['file']?>" alt="" class="img-responsive chambre-img"></a>
                                        </td>
                                <?php
                                    }
                                ?>
                                ...
                                <?php
                                    /*$photoRecup = $bdd->prepare('SELECT * FROM demarcheurs WHERE email=:email');
                                ...
                                <?= $dataAnnoncesInfo['type']?>
                                </td>
                                <td class="orders-date">

                                <!-- Time -->
                                <?= $dataAnnoncesInfo['personne']?>
