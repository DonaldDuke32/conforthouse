              ...
              <table class="table table-sm table-nowrap card-table">
                ...
                <tbody class="list">
                    ...
                    <?php
                        ...
                        $infoAnnonces = $bdd->prepare('SELECT * FROM annonces ORDER BY id DESC');
                        ...
                        while ($dataAnnoncesInfo = $infoAnnonces->fetch()){
                            ...
                            <tr>
                                ...
                                <a href="../<?= $dataAnnoncesInfo['photo']?>"><img src="../<?= $dataAnnoncesInfo['photo']?>" alt="" class="img-responsive chambre-img"></a>
                                </td>
