...
<!-- Mirrored from dashkit.goodthemes.co/account-general.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 May 2022 10:13:17 GMT -->
                ...
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    ...
                    <div class="collapse show" id="sidebarAccount">
                      <ul class="nav nav-sm flex-column">
                        <li class="nav-item">
                          <a href="account-general.php" class="nav-link active">
                            General
                          </a>
                        </li>
                        <li class="nav-item">
            ...
            <li class="nav-item">
              ...
              <div class="collapse " id="sidebarComponents">
                <ul class="nav nav-sm flex-column">
                  ...
                  <li>
                    <a href="docs/components.php#lists" class="nav-link">
                      Lists
                    </a>
                  </li>
                  <li>
                  ...
                  <li>
                    <a href="docs/components.php#navs" class="nav-link">
                      Navs
                    </a>
                  </li>
                  <li>
              ...
              <ul class="dropdown-menu" aria-labelledby="topnavPages">
                <li class="dropend">
                  ...
                  <div class="dropdown-menu" aria-labelledby="topnavAccount">
                    <a class="dropdown-item active" href="account-general.html">
                      General
                    </a>
                    <a class="dropdown-item " href="account-billing.html">
                      Billing
